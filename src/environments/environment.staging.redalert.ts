export const environment = {
  ...
  apiUrl: 'https://api.zetta-staging.work/graphql',
  apiUrlTask: 'https://task-service.zetta-demo.space/graphql',
  microsoftSSO: 'https://api.zetta-staging.work/auth/microsoft',
  fileUrl: 'https://api.kandoo-mgt.pro/fileuploads/',
  tokenKey: 'admtc-token-encryption',
  siteKey: '6Lf8Wt4gAAAAAPujNYlENm3uSCYlj4j7kcI-AOkG',
  timezoneDiff: 1,
  ADYEN_API_KEY: 'test_RICBLCIAFNCZPAJGK6V6NO5EQ4EVRZOU',
  studentEnvironment: 'https://student.zetta-staging.work/',
};
