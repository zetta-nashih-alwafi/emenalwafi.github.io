...
import { StudentProfileInternshipRoutingModule } from './student-profile-internship.routing';
...
@NgModule({
  declarations: [StudentProfileInternshipComponent],
  imports: [
    CommonModule,
    StudentProfileInternshipRoutingModule,
    SharedModule,
    SlickCarouselModule,
...
export class StudentProfileInternshipModule {}
