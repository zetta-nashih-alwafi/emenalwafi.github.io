...
@Component({
  selector: 'ms-second-step-job-offer',
  templateUrl: './second-step-job-offer.component.html',
  styleUrls: ['./second-step-job-offer.component.scss'],
})
export class SecondStepJobOfferComponent implements OnInit, AfterViewChecked, OnDestroy {
