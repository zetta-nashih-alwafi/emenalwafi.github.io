...
@Component({
  selector: 'ms-third-aggrement-form',
  templateUrl: './third-aggrement-form.component.html',
  styleUrls: ['./third-aggrement-form.component.scss'],
  providers: [ParseStringDatePipe],
})
export class ThirdAggrementFormComponent implements OnInit, AfterViewChecked, OnDestroy {
  @Input() candidateId = '';
