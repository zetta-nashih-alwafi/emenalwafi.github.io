...
@Component({
  selector: 'ms-third-step-aggrement',
  templateUrl: './third-step-aggrement.component.html',
  styleUrls: ['./third-step-aggrement.component.scss'],
})
export class ThirdStepAggrementComponent implements OnInit, AfterViewChecked, OnDestroy {
  @Input() candidateId = '';
  ...
  editIdentity() {
    this.candidateService.setStatusEditModeThree(true);
  }
  identityUpdated() {
    this.candidateService.setStatusEditModeThree(false);
    this.candidateService.setStatusStepThree(true);
  }
}
