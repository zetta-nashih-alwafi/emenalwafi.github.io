...
@Component({
  selector: 'ms-eighth-aggrement-form',
  templateUrl: './eighth-aggrement-form.component.html',
  styleUrls: ['./eighth-aggrement-form.component.scss'],
  providers: [ParseStringDatePipe],
})
export class EighthAggrementFormComponent implements OnInit, AfterViewChecked, OnDestroy {
  @Input() candidateId = '';
