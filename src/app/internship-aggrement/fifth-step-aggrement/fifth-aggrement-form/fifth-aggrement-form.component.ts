...
@Component({
  selector: 'ms-fifth-aggrement-form',
  templateUrl: './fifth-aggrement-form.component.html',
  styleUrls: ['./fifth-aggrement-form.component.scss'],
  providers: [ParseStringDatePipe],
})
export class FifthAggrementFormComponent implements OnInit, AfterViewChecked, OnDestroy {
  @Input() candidateId = '';
