...
@Component({
  selector: 'ms-internship-report-tab',
  templateUrl: './internship-report-tab.component.html',
  styleUrls: ['./internship-report-tab.component.scss'],
})
export class InternshipReportTabComponent implements OnInit, OnChanges, OnDestroy, AfterViewInit {
