...
@Component({
  selector: 'ms-job-offer-history-tab',
  templateUrl: './job-offer-history-tab.component.html',
  styleUrls: ['./job-offer-history-tab.component.scss'],
})
export class JobOfferHistoryTabComponent implements OnInit {
