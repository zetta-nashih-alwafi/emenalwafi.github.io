...
@Component({
  selector: 'ms-job-offer-profile-tab',
  templateUrl: './job-offer-profile-tab.component.html',
  styleUrls: ['./job-offer-profile-tab.component.scss'],
})
export class JobOfferProfileTabComponent implements OnInit {
