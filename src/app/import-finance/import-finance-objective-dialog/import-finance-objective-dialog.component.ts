...
@Component({
  selector: 'ms-import-finance-objective-dialog',
  templateUrl: './import-finance-objective-dialog.component.html',
  styleUrls: ['./import-finance-objective-dialog.component.scss'],
  providers: [ParseStringDatePipe],
})
export class ImportFinanceObjectiveDialogComponent implements OnInit, OnDestroy {
  private subs = new SubSink();
  importForm: UntypedFormGroup;

  constructor(
    public dialogRef: MatDialogRef<ImportFinanceObjectiveDialogComponent>,
  ...
  downloadFile() {
    ...
    this.financeService.downloadGeneralFinanceTemplateCSV(opening, closing, this.data.delimiter, scholarSeasons, schools, campus, levels);
