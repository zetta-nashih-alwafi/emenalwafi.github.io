...
@Component({
  selector: 'ms-history-lettrage-dialog',
  templateUrl: './history-lettrage-dialog.component.html',
  styleUrls: ['./history-lettrage-dialog.component.scss'],
  providers: [ParseUtcToLocalPipe, ParseStringDatePipe],
})
export class HistoryLettrageDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    public dialogRef: MatDialogRef<HistoryLettrageDialogComponent>,
