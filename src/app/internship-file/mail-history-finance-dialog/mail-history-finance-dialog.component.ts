...
@Component({
  selector: 'ms-mail-history-finance-dialog',
  templateUrl: './mail-history-finance-dialog.component.html',
  styleUrls: ['./mail-history-finance-dialog.component.scss'],
})
export class MailHistoryFinanceDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<MailHistoryFinanceDialogComponent>,
  ...
  getDataStudent() {
    if (this.data && this.data.length) {
      this.data.forEach((element) => {
        ...
        if (this.validateEmail(element.email)) {
          this.selectedRecepientsList.push(element.email);
          console.log('Success');
        } else {
          console.log('Eror');
        }
        this.recpList.push(element.email);
      });
    }
  ...
  getEmailMessage() {
    ...
    if (this.data && this.data.length) {
      ...
      this.data.forEach((person, index) => {
        greeting += this.translate.instant(person.civility) + ' ' + person.first_name + ' ' + person.last_name;
