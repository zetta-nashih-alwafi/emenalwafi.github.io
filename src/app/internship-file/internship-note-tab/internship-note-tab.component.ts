...
@Component({
  selector: 'ms-internship-note-tab',
  templateUrl: './internship-note-tab.component.html',
  styleUrls: ['./internship-note-tab.component.scss'],
})
export class NoteInternshipComponent implements OnInit {
