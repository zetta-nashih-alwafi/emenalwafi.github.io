...
@Component({
  selector: 'ms-internship-history-tab',
  templateUrl: './internship-history-tab.component.html',
  styleUrls: ['./internship-history-tab.component.scss'],
})
export class InternshipHistoryTabComponent implements OnInit {
  ...
  getCandidatesHistoryData() {
    ...
    this.subs.sink = this.candidatesHistoryService.getCandidatesHistory('pagination', this.sortValue, 'filter').subscribe((histories) => {
