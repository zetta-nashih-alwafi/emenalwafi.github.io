...
@Component({
  selector: 'ms-internship-card-list',
  templateUrl: './internship-card-list.component.html',
  styleUrls: ['./internship-card-list.component.scss']
})
export class InternshipCardListComponent implements OnInit {
