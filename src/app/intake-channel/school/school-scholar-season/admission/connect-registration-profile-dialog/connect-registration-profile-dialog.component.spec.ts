...
import { MatCommonModule, MatButtonModule, MatDialogRef, MAT_DIALOG_DATA, MatDialogModule } from '@angular/material';
...
import { ConnectRegistrationProfileDialogComponent } from './connect-registration-profile-dialog.component';

describe('ConnectRegistrationProfileDialogComponent', () => {
  let component: ConnectRegistrationProfileDialogComponent;
  let fixture: ComponentFixture<ConnectRegistrationProfileDialogComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ ConnectRegistrationProfileDialogComponent ],
      imports: [
        CommonModule,
        MatCommonModule,
        MatButtonModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ConnectRegistrationProfileDialogComponent);
