...
@Component({
  selector: 'ms-candidate-note-tab',
  templateUrl: './candidate-note-tab.component.html',
  styleUrls: ['./candidate-note-tab.component.scss'],
})
export class CandidateNoteTabComponent implements OnInit {
