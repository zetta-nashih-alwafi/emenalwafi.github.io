...
@Component({
  templateUrl: './student-urgent-dialog.component.html',
  styleUrls: ['./student-urgent-dialog.component.scss'],
})
export class StudentUrgentDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<StudentUrgentDialogComponent>,
  ...
  getDataStudent() {
    this.preSelectedEmail =
      (this.data && this.data.civility && this.data.civility !== 'neutral' ? this.translate.instant(this.data.civility) + ' ' : '') +
  ...
  getEmailMessage() {
    ...
    if (this.data.admission_member_id) {
      signat +=
        (this.data &&
        this.data.admission_member_id &&
        this.data.admission_member_id.civility &&
        this.data.admission_member_id.civility !== 'neutral'
                  ...
                  .filter(
                    (mail) =>
                      !this.selectedRecepientsList.includes(
                        (mail && mail.civility && mail.civility !== 'neutral' ? this.translate.instant(mail.civility) + ' ' : '') +
                          mail.first_name +
                          ' ' +
                          mail.last_name +
                          ' ' +
