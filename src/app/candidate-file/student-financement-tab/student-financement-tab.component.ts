...
@Component({
  selector: 'ms-student-financement-tab',
  templateUrl: './student-financement-tab.component.html',
  styleUrls: ['./student-financement-tab.component.scss'],
})
export class StudentFinancementTabComponent implements OnInit, OnChanges, OnDestroy {
  @Input() candidateId;
  @Input() userData;
