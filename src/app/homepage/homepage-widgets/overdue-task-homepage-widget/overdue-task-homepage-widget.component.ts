...
@Component({
  selector: 'ms-overdue-task-homepage-widget',
  standalone: true,
  imports: [CommonModule, SharedModule],
  providers: [ParseUtcToLocalPipe],
  templateUrl: './overdue-task-homepage-widget.component.html',
  styleUrls: ['./overdue-task-homepage-widget.component.scss'],
})
export class OverdueTaskHomepageWidgetComponent implements OnInit, OnDestroy {
  tasks: any[] = [];
  ...
  getOverDueTaskData() {
    ...
    const filter = { task_status: 'todo', is_not_parent_task: true, over_due_date: true };
